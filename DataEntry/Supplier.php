                            ...
                            <table style="height:100px;width:100%;">
                                <tr >
                                    ...
                                    <td style="padding-top:0px">
                                        ...
                                        <a style="margin-left:5%;text-decoration:none;color:white;text-align:right;" id="anchor_return" href="javascript:parent.datapage.navigateTo('Suppliers',pages);" >
