...
class Company
{
     ...
     */
     ...
     function CreateTable(){
          $stmt = $this->con->prepare("CREATE TABLE IF NOT EXISTS `entreprise` (`id` INT NOT NULL AUTO_INCREMENT, `images` VARCHAR(255), `name` VARCHAR(100), `type` VARCHAR(255), `address` VARCHAR(255), `zipcode` VARCHAR(50),`city` VARCHAR(50), `description` VARCHAR(255), PRIMARY KEY (`id`)); ");
          if($stmt->execute()) {
             return true; 
          }
          return false;
