...
class DataPages
{
     ...
     */
     ...
     function CreateTable(){
          $stmt = $this->con->prepare("CREATE TABLE IF NOT EXISTS `DataPages` (`id` INT NOT NULL AUTO_INCREMENT, `page_id` VARCHAR(100), `title` VARCHAR(100), `url` VARCHAR(255), `div_menu` VARCHAR(50), PRIMARY KEY (`id`)); ");
          if($stmt->execute()) {
             return true; 
          }
          return false;
