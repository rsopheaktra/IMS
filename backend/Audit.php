...
class Audit
{
     ...
     */
     ...
     function CreateTable(){
          $stmt = $this->con->prepare("CREATE TABLE IF NOT EXISTS `audit` (`id` INT NOT NULL AUTO_INCREMENT, `created_at` DATE, `username` VARCHAR(100), `page_id` INT, `menu` VARCHAR(25), `description` VARCHAR(255), PRIMARY KEY (`id`)); ");
          if($stmt->execute()) {
             return true; 
          }
          return false;
