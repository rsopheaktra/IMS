...
class Shippers
{
     ...
     */
     function DataEntry($company, $first_name, $last_name, $email, $mobile_phone, $fixed_phone, $address, $zipcode, $city, $country){
          $stmt = $this->con->prepare("INSERT INTO Shippers (company, first_name, last_name, email, mobile_phone, fixed_phone, address, zipcode, city, country) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
 ...
 */
 function DataEdit($id, $company, $first_name, $last_name, $email, $mobile_phone, $fixed_phone, $address, $zipcode, $city, $country){
     $stmt = $this->con->prepare("UPDATE Shippers SET company = ?, first_name = ?, last_name = ?, email = ?, mobile_phone = ?, fixed_phone = ?, address = ?, zipcode = ?, city = ?, country = ? WHERE id = ?");
 ...
 */
 function Delete($id){
    $stmt = $this->con->prepare("DELETE FROM Shippers WHERE id = ? ");
 ...
 */
 function getAll(){
 $stmt = $this->con->prepare("SELECT id, company, first_name, last_name, email, mobile_phone, fixed_phone, address, zipcode, city, country FROM Shippers");
 $stmt->execute();
...
function getByID($id){
 ...
 $stmt = $this->con->prepare("SELECT id, company, first_name, last_name, email, mobile_phone, fixed_phone, address, zipcode, city, country FROM Shippers WHERE id = " .$id);
 $stmt->execute();
 $stmt->bind_result($id, $company, $first_name, $last_name, $email, $mobile_phone, $fixed_phone, $address, $zipcode, $city, $country);
...
function getLast(){
 $stmt = $this->con->prepare("SELECT id, company, first_name, last_name, email, mobile_phone, fixed_phone, address, zipcode, city, country FROM Shippers ORDER BY id DESC LIMIT 1;");
 $stmt->execute();
 $stmt->bind_result($id, $company, $first_name, $last_name, $email, $mobile_phone, $fixed_phone, $address, $zipcode, $city, $country);
